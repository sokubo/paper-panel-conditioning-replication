...
Computational commit checked against the manuscript: not yet checked for this version. The `RELEASE_CHECK*` files in this snapshot are the record of the previously checked commit `ea044e655ced00e05f2a2442ab0fc19c607c5d77`, whose scripts or outputs differ from these; the release check is rerun on this version before it is tagged, and this line is then regenerated.
